      ...
      <div class="container-custom">
        <div class="flex items-center justify-between h-16 lg:h-20">
          ...
          <div class="flex items-center space-x-3">
            <div class="w-10 h-10 lg:w-12 lg:h-12 bg-theme-primary rounded-full flex items-center justify-center">
              <span class="material-icons text-theme-on-primary text-xl lg:text-2xl">account_balance</span>
            </div>
            <div class="text-lg lg:text-xl font-bold"
                 [class.text-white]="!isScrolled"
                 [class.text-theme-on-background]="isScrolled">
              BMC
            </div>
          </div>
          ...
          <div class="hidden md:flex items-center space-x-8">
            <a routerLink="/"
               ...
               [class.text-white]="!isScrolled"
               [class.text-theme-on-background]="isScrolled"
               [class.hover:text-theme-primary]="isScrolled"
               [class.hover:text-theme-warn]="!isScrolled">
              HOME
            </a>
            ...
            <div class="relative group">
              ...
              <div class="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg rounded-md py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <a routerLink="/membership/form" class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300">MEMBERSHIP FORM</a>
                <a routerLink="/membership/existing" class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300">EXISTING MEMBERS</a>
              </div>
            </div>
            ...
            <div class="relative group">
              ...
              <div class="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg rounded-md py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                <a routerLink="/committee/executive" class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300">EXECUTIVE COMMITTEE</a>
                <a routerLink="/committee/sub" class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300">SUB COMMITTEE</a>
                <a routerLink="/committee/past" class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300">PAST COMMITTEE</a>
              </div>
            </div>
        ...
        <div class="md:hidden transition-all duration-300 overflow-hidden"
          ...
          <div class="py-4 space-y-2">
            <a routerLink="/"
               class="block px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300"
            ...
            <div>
              <button class="flex items-center justify-between w-full px-4 py-2 text-theme-on-background hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300"
            ...
            <div>
              ...
              <div class="ml-4 space-y-1" [class.hidden]="!mobileDropdowns['membership']">
                <a routerLink="/membership/form" class="block px-4 py-2 text-gray-600 hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300" (click)="closeMobileMenu()">MEMBERSHIP FORM</a>
                <a routerLink="/membership/existing" class="block px-4 py-2 text-gray-600 hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300" (click)="closeMobileMenu()">EXISTING MEMBERS</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="ml-4 space-y-1" [class.hidden]="!mobileDropdowns['committee']">
                <a routerLink="/committee/executive" class="block px-4 py-2 text-gray-600 hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300" (click)="closeMobileMenu()">EXECUTIVE COMMITTEE</a>
                <a routerLink="/committee/sub" class="block px-4 py-2 text-gray-600 hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300" (click)="closeMobileMenu()">SUB COMMITTEE</a>
                <a routerLink="/committee/past" class="block px-4 py-2 text-gray-600 hover:bg-theme-primary hover:text-theme-on-primary transition-colors duration-300" (click)="closeMobileMenu()">PAST COMMITTEE</a>
              </div>
            </div>

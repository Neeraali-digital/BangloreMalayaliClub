...
@Component({
  ...
  template: `
    <!-- Hero Section -->
    <section class="pt-24 pb-16 bg-gradient-to-r from-kerala-water to-kerala-green">
          ...
          <div>
            ...
            <div class="flex items-center space-x-4">
              <div class="text-center">
                <div class="text-3xl font-bold text-kerala-gold">35+</div>
                <div class="text-sm text-gray-600">Years of Service</div>
              </div>
              <div class="text-center">
                <div class="text-3xl font-bold text-kerala-gold">2000+</div>
                <div class="text-sm text-gray-600">Active Members</div>
              </div>
              <div class="text-center">
                <div class="text-3xl font-bold text-kerala-gold">50+</div>
                <div class="text-sm text-gray-600">Annual Events</div>
              </div>
            </div>
          </div>
          <div class="relative">
            <div class="bg-kerala-gold rounded-lg p-8 text-white">
    ...
    <section class="section-padding bg-gray-50">
      <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="text-center">
            <div class="w-16 h-16 bg-kerala-gold rounded-full flex items-center justify-center mx-auto mb-4">
              <span class="material-icons text-white text-2xl">favorite</span>
            </div>
            <h3 class="text-xl font-semibold mb-2">Unity</h3>
            <p class="text-gray-600">Bringing together Malayalis from all walks of life</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Preserving our rich cultural heritage</p>
          </div>

          <div class="text-center">
            <div class="w-16 h-16 bg-kerala-gold rounded-full flex items-center justify-center mx-auto mb-4">
              <span class="material-icons text-white text-2xl">diversity_3</span>
            </div>
            <h3 class="text-xl font-semibold mb-2">Inclusion</h3>
            <p class="text-gray-600">Welcoming everyone with open arms</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Evolving while staying true to our roots</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="card p-6 text-center">
            <div class="w-24 h-24 bg-kerala-gold rounded-full flex items-center justify-center mx-auto mb-4">
              <span class="material-icons text-white text-3xl">person</span>
            </div>
            <h3 class="text-xl font-semibold mb-2">Rajesh Kumar</h3>
            <p class="text-kerala-gold font-medium mb-2">President</p>
            <p class="text-gray-600 text-sm">Leading the club with vision and dedication for over 5 years</p>
          </div>
          ...
          <div class="card p-6 text-center">
            ...
            <p class="text-kerala-gold font-medium mb-2">Vice President</p>
            <p class="text-gray-600 text-sm">Passionate about cultural programs and community outreach</p>
          </div>
          ...
          <div class="card p-6 text-center">
            ...
            <p class="text-kerala-gold font-medium mb-2">Secretary</p>
            <p class="text-gray-600 text-sm">Ensuring smooth operations and member engagement</p>
          </div>
        </div>
      </div>
    </section>
